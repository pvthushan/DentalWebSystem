...
<head>
    ...
    <script>
        function filterDoctors() {
            let searchInput = document.getElementById("doctorSearch");
            let filter = searchInput.value.trim().toUpperCase();
            ...
            for (let i = 1; i < tr.length; i++) {
                ...
                if (nameTd || specTd) {
                    ...
                    if (nameText.toUpperCase().indexOf(filter) > -1 || specText.toUpperCase().indexOf(filter) > -1) {
                        tr[i].style.display = "";
                    } else {
...
<div class="sidebar">
    ...
    <div class="nav-menu">
        ...
        <a href="manager-doctor-availability" class="nav-btn active">👨‍⚕️ Doctor Availability</a>
...
<div class="main-content">
    ...
    <div class="search-box-container">
        ...
        <input type="text" id="doctorSearch" class="search-input" onkeyup="filterDoctors()" placeholder="Search by Doctor Name or Specialization..." maxlength="50">
    </div>
    ...
    <table id="doctorsTable">
        ...
        %>
        <tr>
            <td colspan="5" style="text-align: center; color: #7f8c8d; padding: 25px;">No doctors found in the database.</td>
        </tr>
        <% } %>
        </tbody>
    </table>
