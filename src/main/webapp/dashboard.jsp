...
<%
    ...
    String safeFullName = user.getFullName().replaceAll("[<>]", "");
...
<div class="navbar">
    ...
    <div class="user-info">
        <span>Welcome, <strong><%= safeFullName %></strong></span>
        <span class="badge"><%= safeUserRole %></span>
...
<div class="footer">
    &copy; 2026 Sunrise Dental Clinic - All Rights Reserved. Enterprise Standard v1.0
</div>
