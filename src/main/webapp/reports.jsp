...
<%
    ...
    String safeUserRole = (userRole != null) ? userRole.replaceAll("[<>]", "") : "";
%>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <script>
        function validateReportExport() {
            if (confirm("Do you want to generate and print/export the clinical analytics report?")) {
                window.print();
            }
        }
    </script>
...
<div class="container">
    ...
    <div class="header-card">
        <div>
            ...
            <p>Real-time analytics, revenue summaries, and treatment demand metrics for management. Logged in as: <strong><%= safeUsername %></strong></p>
        </div>
        <button class="btn-export no-print" onclick="validateReportExport()">Export / Print PDF</button>
    </div>
